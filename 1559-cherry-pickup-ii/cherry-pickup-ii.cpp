...
public:
    ...
    int find(vector<vector<int>>&grid,int i1,int j1,int i2,int j2){
        ...
        if(j1==j2){
            return dp[i1][j1][j2]=grid[i1][j1]+max({find(grid,i1+1,j1+1,i2+1,j2),find(grid,i1+1,j1+1,i2+1,j2+1),find(grid,i1+1,j1+1,i2+1,j2-1),find(grid,i1+1,j1,i2+1,j2),find(grid,i1+1,j1,i2+1,j2+1),find(grid,i1+1,j1,i2+1,j2-1),find(grid,i1+1,j1-1,i2+1,j2),find(grid,i1+1,j1-1,i2+1,j2+1),find(grid,i1+1,j1-1,i2+1,j2-1)});// we tried all combos
        }
        else {
